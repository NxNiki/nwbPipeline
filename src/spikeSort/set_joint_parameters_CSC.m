...
% EM: This function needs to stay in sync with wave_clus, or the parameters
% used to create the clusters won't be the ones used to run wave_clus,
% which is problematic. To solve this, I use this function with a single
% input, as it was originally written, during clustering. Instead of
% calling set_parameters_ascii_spikes in wave_clus, I now call this
% function, but with two arguments passed in, a filename and handles. In
% this case, par.sr will not be set, but that shouldn't matter for
% clustering. Perhaps....
