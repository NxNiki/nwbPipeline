...
[spindlesTimes, spindleStats, spindlesStartEndTimes] = detector.findSlowWavesStaresina(currData, sleepScoring, peakTimes, returnStats);
...
detector.plotSpindlesSimple(currData, spindlesTimes, outputFolder)
